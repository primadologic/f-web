        ...
        <div className="bg-custom-primary-400 text-primary-foreground sm:w-full sm:flex sm:justify-center sm:items-center w-full justify-center items-center">
            <div className="sm:w-[80vw] lg:w-full lg:px-10 xl:w-[80vw] md:w-full w-full px-5 py-10 space-y-10">
                ...
                <div className="">
                    ...
                    <div className="leading-[24.38px] flex flex-col gap-5 break-words ">
                        <div className="flex flex-col justify-start gap-2">
                            <h2 className="font-medium text-[24px]">What We Do</h2>
                            <p className="sm:text-justify sm:text-base text-sm text-justify">
                        ...
                        <div className="flex flex-col justify-start gap-2">
                            <h2 className="font-medium text-[24px]">How It Works</h2>
                            <p className="sm:text-justify sm:text-base text-sm text-justify">
                        ...
                        <div className="flex flex-col justify-start gap-2">
                            <h2 className="font-medium text-[24px]">Reporting and Awareness</h2>
                            <p className="sm:text-justify sm:text-base text-sm text-justify">
                        ...
                        <div className="flex flex-col justify-start gap-2">
                            <h2 className="font-medium text-[24px]">Integration and Accessibility</h2>
                            <p className="sm:text-justify sm:text-base text-sm text-justify">
                        ...
                        <div className="flex flex-col justify-start gap-2">
                            <h2 className="font-medium text-[24px]">Our Vision</h2>
                            <p className="sm:text-justify sm:text-base text-sm text-justify">
                        ...
                        <div className="flex flex-col justify-start gap-2">
                            <h2 className="font-medium text-[24px]">Join Us</h2>
                            <p className="sm:text-justify sm:text-base text-sm text-justify">
